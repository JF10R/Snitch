...
If Snitch reports something that isn't a real vulnerability, open a [False Positive issue](https://github.com/JF10R/Snitch/issues/new?template=false_positive.md). These are the most valuable bug reports — they make Snitch smarter for everyone.
